...
from flights.views import FlightListView, BookingListView, BookingDetailView, BookingUpdateView, BookingCancelView, BookingCreateView
...
urlpatterns = [
    ...
    path("booking/create/", BookingCreateView.as_view(), name="book-flight"),
